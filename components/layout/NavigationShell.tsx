    ...
    return (
      <>
        ...
        <>
            ...
            <Link href="/dashboard/seller/farm-records" className="hover:opacity-80 transition block py-2 md:py-0">Farm Condition & Digital Records</Link>
            <Link href="/dashboard/seller/device-readings" className="hover:opacity-80 transition block py-2 md:py-0">Connected Devices</Link>
          </>
        ) : null}
